    ...
    */
    ...
    'menu' => [
        ...
        [
            ...
            'submenu' => [
                [
                    'text' => 'Lancamento Gerencial',
                    'url'  => '/financeiro/index',
                    'icon'    => 'fas fa-file-invoice-dollar',
                ],
                [
                    'text' => 'Baixa de Lancamentos',
                    'url'  => '/financeiro/indexBaixa',
                    'icon' => 'fas fa-donate',
        ...
        [
            ...
            'submenu' => [
                [
                    ...
                    'url'  => '/relatorio/indexuser',
                    'icon'    => 'fas fa-users',
                ],
                [
                    'text' => 'Relatorio de Produtos',
                    'url'  => '/relatorio/indexproducts',
                    'icon'    => 'fas fa-file-alt',
                ],
            ],
        ],
