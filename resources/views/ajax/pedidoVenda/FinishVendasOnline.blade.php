                ...
                <div class="main-content">  
                            ...
                            @endphp
                               <form action="{{route('updateFinish.vendasonline',$pedidoVenda->id)}}" method="post">
                                ...
                                <div class="form-row">
                                    @csrf
                                <input type="hidden" name="numberPedido" value="{{$number}}">
                                    <div class="form-group col-md-12">
                                        <label for=""> Status:</label>
                                        <select class="form-control" name="statusPedido"  id="statusPedido{{$number}}"><br>
                                     ...
                                     <div class="form-group col-md-12">
                                        ...
                                        <textarea  class="form-control" rows="6"  type="text" id="observacoes{{$number}}" name="observacoes" placeholder="Descrição:"  value=""></textarea>
