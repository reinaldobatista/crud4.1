          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item">Cadastrar Caixa</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
            ...
            <section class="col-lg-12 connectedSortable">
              ...
              <div class="card direct-chat direct-chat-primary">
                <div class="card-header bg-primary">
                  <h3 class="card-title">Cadastrar Caixa</h3>
                ...
                <div class="card-body">
                  <main>
                    <form action="{{route('store.caixa')}}" method="post" name="form-caixa" enctype="multipart/form-data" onsubmit="return validarCaixa()">
