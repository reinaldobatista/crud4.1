          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active"><a href="{{route('index.caixa')}}">Gerenciamento de Caixa</a></li>
                <li class="breadcrumb-item">Editar Caixa</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
            ...
            <section class="col-lg-12 connectedSortable">
              ...
              <div class="card direct-chat direct-chat-primary">
                <div class="card-header bg-primary">
                  <h3 class="card-title">Editar Caixa</h3>
                ...
                <div class="card-body">
                  <main>
                    <form action="{{route('update.caixa',$caixa->id)}}" method="post" name="form-caixa" enctype="multipart/form-data" onsubmit="return validarCaixa()">
                      @method('PUT')
                            ...
                            <div class="panel-cad-cadastro">
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-4">
                                        ...
                                        <input class="form-control" type="text" name="name" value="{{ $caixa->name ?? old('name')}}">
                                    ...
                                    <div class="form-group col-md-4">
                                      ...
                                      <select class="form-control" type="text" name="banco_id">
                                        <option value="{{$banco->id ??''}}">{{$banco->name ?? 'Selecione o Banco'}}</option>
                                  ...
                                  @endphp
                                  <div class="form-group col-md-4">
                                    <label for="">Valor Atual:</label>
                                    <input class="form-control" type="text" name="value" value="{{$value ?? old('value')}}">
                                    <div style="color: red ; background:rgb(233, 163, 163)"><small id="erro3"></small></div><br>
                                </div>
                                <input class="form-control"  type="text" name="id" value="{{$caixa->id}}" hidden>
                                </div>
                                <div class="butons">
                                    <button type="submit" class="btn btn-success" id="salvar"> Salvar </button>
                                    <a href="{{route('index.caixa')}}" class="btn btn-default"> Cancelar</a>
                                </div> 
                            </div>
