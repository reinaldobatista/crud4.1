          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item">Cadastrar Banco</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
            ...
            <section class="col-lg-12 connectedSortable">
              ...
              <div class="card direct-chat direct-chat-primary">
                <div class="card-header bg-primary">
                  <h3 class="card-title">Cadastrar Banco</h3>
                ...
                <div class="card-body">
                  <main>
                    <form action="{{route('store.banco')}}" method="post" name="form-banco" enctype="multipart/form-data" onsubmit="return validarBanco()">
                            ...
                            <div class="panel-cad-cadastro">
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-4">
                                      ...
                                      <input class="form-control" type="int" name="conta" id="conta" value="{{ old('conta')}}">
                                      <div style="color: red ; background:rgb(233, 163, 163)"><small id="erro2"></small></div><br>
                                    </div>
                                    <div class="form-group col-md-4">
                                      <label for="">N° Banco:</label>
                                      <input class="form-control" type="int" name="Nbanco" id="Nbanco" value="{{ old('Nbanco')}}">
