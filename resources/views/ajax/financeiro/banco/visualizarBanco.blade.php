          ...
          <li class="nav-item has-treeview">
            ...
            <li class="nav-item has-treeview menu-open">
              ...
              <ul class="nav nav-treeview ">
                ...
                <li class="nav-item">
                  <a href="/banco/index" class="nav-link active">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item">Banco</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
              ...
              <div class="card-body">
                <div class="main-content">   
                  <div class="panel-row">
                    ...
                    <a href="{{route('create.banco')}}">
                        <button class="panel panel-50" ><i class="fas fa-plus"></i>Cadastrar</button>
                        
                    </a>
                  </div>
                    <form action="{{route('banco.search')}}" method="post">
                      @csrf
                      <div class="form-row">
                        ...
                        <div class="form-group col-md-3">
                          ...
                          <input type="text" name="filter3" class="form-control" value="{{ $filters['filter3'] ?? ''}}">
                        </div>
                        <div class="form-group col-md-3">
                          <label for="">N° Banco:</label>
                          <input type="text" name="filter4" class="form-control" value="{{ $filters['filter4'] ?? ''}}">
                          <div class="butons">
                          ...
                          <table class="table table-bordered data-table table-head-fixed text-center" id="example" >
                              <thead >
                                <tr>
                                  ...
                                  <th scope="col" class="bg-primary">Conta</th>
                                  <th scope="col" class="bg-primary">N° Banco</th>
                                ...
                                @foreach($bancos as $banco )
                                  <tr role="row" class="odd">
                                    ...
                                    <td class="td-row" style="display:flex; flex-direction: row; align-items: center;justify-content: center;">
                                      <a href="{{route('edit.banco',$banco->id)}}">
                                        <button class="btn btn-primary" onclick="fetchContent(this)">
                                            <i class="fas fa-edit"></i>
                                        </button>
                                      </a>
                                      <form class="form-danger" id="{{$banco->id}}" action="{{route('destroy.banco',$banco->id)}}"  method="POST">
                                        @csrf
                                        @method('DELETE')
