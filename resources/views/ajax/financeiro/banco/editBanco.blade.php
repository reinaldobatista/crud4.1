          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item active"><a href="{{route('index.caixa')}}">Banco</a></li>
                <li class="breadcrumb-item">Editar Banco</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
          ...
          <div class="row">
            ...
            <section class="col-lg-12 connectedSortable">
              ...
              <div class="card direct-chat direct-chat-primary">
                ...
                <div class="card-body">
                  <main>
                    <form action="{{route('update.banco',$banco->id)}}" method="post" name="form-caixa" enctype="multipart/form-data" onsubmit="return validarBanco()">
                      @method('PUT')
                                ...
                                <div class="form-row">
                                    @csrf
                                      <div class="form-group col-md-4">
                                        ...
                                        <input class="form-control" type="text" name="name" value="{{$banco->name ?? old('name')}}">
                                        <div style="color: red ; background:rgb(233, 163, 163)"><small id="erro1"></small></div><br>
                                      </div>
                                      <div class="form-group col-md-4">
                                          <label for="">Conta:</label>
                                          <input class="form-control" type="int" name="conta" value="{{$banco->conta ?? old('conta')}}">
                                          <div style="color: red ; background:rgb(233, 163, 163)"><small id="erro2"></small></div><br>
                                      </div>
                                      <div class="form-group col-md-4">
                                        <label for="">N° Banco:</label>
                                        <input class="form-control" type="int" name="Nbanco" value="{{$banco->Nbanco ?? old('Nbanco')}}">
                                        <div style="color: red ; background:rgb(233, 163, 163)"><small id="erro3"></small></div><br>
                                      </div>
                                      <input class="form-control"  type="text" name="id" value="{{$banco->id}}" hidden>
                                </div>
                                <div class="butons">
                                    <button type="submit" class="btn btn-success" id="salvar"> Salvar </button>
                                    <a href="{{route('index.banco')}}" class="btn btn-default"> Cancelar</a>
                                </div> 
                            </div>
