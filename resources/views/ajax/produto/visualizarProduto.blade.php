                              ...
                              <form action="{{route('products.search')}}" method="post">
                                ...
                                <div class="form-row">
                                  ...
                                  <div class="form-group col-md-3">
                                    ...
                                    <select class="form-control select text-center" name="filter1"  id="filter1" ><br>
                                      @php
                                          $category_filter=$categorys->find($filters['filter1'] ?? "");
                                      @endphp
                                      @if ($category_filter==null)
                                      <option  value="{{ $filters['filter1'] ?? ''}}">{{$category_filter->category ?? 'Selecione a Categoria'}}</option>
                                      @else
                                         <option  value="{{ $filters['filter1'] ?? ''}}">{{$category_filter->category ?? 'Selecione a Categoria'}}</option>
                                      ...
                                      @foreach($categorys as $category)
                                        @if ($category_filter!==null)
                                          @if ($category_filter->category==$category->category)
